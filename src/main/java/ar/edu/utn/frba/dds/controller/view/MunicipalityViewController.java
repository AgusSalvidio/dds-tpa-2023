...
public class MunicipalityViewController {
    ...
    public void index(Context context) {
        ...
        model.put("object-list",
                this.applicationContext.municipalityManagementSystem().objectList(Municipality.class.getName()));
    ...
    public void edit(Context context) throws Exception {
        ...
        Municipality registered_object = this.applicationContext.municipalityManagementSystem().municipalityById(id);
        model.put("user", this.applicationContext.loggedUser(context));
        model.put("title", pageTitle);
        model.put("action", actionString);
    ...
    public void update(Context context) throws Exception {
        ...
        this.applicationContext.municipalityManagementSystem().updateFromModel(registered_object, model);
    ...
    public void delete(Context context) throws Exception {
        Integer id = Integer.parseInt(context.pathParam("id"));
        Municipality registered_object = this.applicationContext.municipalityManagementSystem().municipalityById(id);
        this.applicationContext.municipalityManagementSystem().stopManaging(registered_object);
        context.redirect(actionString);
    }
